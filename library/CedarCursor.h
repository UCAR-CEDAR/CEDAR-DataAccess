...
#ifndef CedarCursor_h_
#define CedarCursor_h_
...
class CedarCursor
{
  ...
  public:
  CedarCursor() : r( 0 ) { }
  CedarCursor(CedarDataRecord *p) : r( p ) { }
  void attach(CedarDataRecord *p) { r = p ; } 
};

#endif // CedarCursor_h_
